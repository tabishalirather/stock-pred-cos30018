...
def create_model(num_layers, units_per_layer, layer_name, num_time_steps, number_of_features, activation,
                 steps_to_predict, loss, optimizer, metrics, ):
	print("Lock and load")
	...
	for layer in range(num_layers):
		...
		if (layer == 0):
			...
			'''
			dl_model.add(layer_name(units_per_layer, batch_input_shape=(None, num_time_steps, number_of_features),
