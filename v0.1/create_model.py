...
def create_model(num_layers, units_per_layer, layer_name, num_time_steps, number_of_features, activation, loss="mean_absolute_error", optimizer="rmsprop", metrics="mean_absolute_error"):
	print("Lock and load")
	...
	dl_model.add(Dense(num_time_steps, activation='tanh'))
